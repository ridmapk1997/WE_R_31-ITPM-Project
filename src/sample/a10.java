...
public class a10 extends javax.swing.JFrame {
    ...
    public a10() {
        initComponents();
        try {
            ResultSet r=dbms.search("SELECT * FROM loc");
            while(r.next()){
                String id=r.getString("id");
                String a=r.getString("bn");
                String b=r.getString("rn");
                String c=r.getString("rm1");
                String d=r.getString("rm2");
                String e=r.getString("c");
                Vector v=new Vector();
                v.add(id);
                v.add(a);
                v.add(b);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Building", "Room", "Room Type 1", "Room Type 2", "Capacity"
            }
        ));
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
       // TODO add your handling code here:       
        ...
        if (r < 0) {
            ...
            String a = String.valueOf(o);
            try {
                dbms.iud("DELETE FROM loc WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbms.iud("UPDATE loc SET bn = '" + jTextField9.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE loc SET rn = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE loc SET c = '" + jTextField10.getText() + "' WHERE `id` = '"+ id +"'");

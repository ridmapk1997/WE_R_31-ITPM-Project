...
public class a17 extends javax.swing.JFrame {
    ...
    public a17() {
        ...
        loadData("stu_grp", "id", jComboBox2);
        loadData("sessions", "selec_rm", jComboBox3);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("GENERATE TIME TABLES");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lecturers", "Group", "Subject", "Students", "Duration", "Room", "Session", "Day", "Start Time", "End Time"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jButton40, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton40ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton40ActionPerformed
        ...
        while(r.next()){
        String a=r.getString("selec_lec");
        String a1=r.getString("sg");
        String a2=r.getString("ss");
        String a3=r.getString("stu");
        String a4=r.getString("d");
        String a5=r.getString("selec_rm");
        String a6=r.getString("selec_ses");
        String a7=r.getString("selec_day");
        String a8=r.getString("stime");
        String a9=r.getString("et");
        Vector v=new Vector();
        v.add(a);
        v.add(a1);
        v.add(a2);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        // TODO add your handling code here:
        TableModel tm=jTable1.getModel();
        DefaultTableModel d=(DefaultTableModel)tm;
        d.setRowCount(0);
        try {
        String result = String.valueOf(jComboBox1.getSelectedItem());
        ResultSet r = dbms.search("SELECT * FROM sessions WHERE selec_lec = '"+result+"' ");
        while(r.next()){
        String a=r.getString("selec_lec");
        String a1=r.getString("sg");
        String a2=r.getString("ss");
        ...
        DefaultTableModel dtmodel=(DefaultTableModel)tmodel;
        dtmodel.addRow(v);    
        }
        } catch (Exception e) {
        e.printStackTrace();
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        d.setRowCount(0);
        try {
        String result = String.valueOf(jComboBox2.getSelectedItem());
        ResultSet r = dbms.search("SELECT * FROM sessions WHERE sg = '"+result+"' ");
        while(r.next()){
        String a=r.getString("selec_lec");
        String a1=r.getString("sg");
        String a2=r.getString("ss");
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        ...
        d.setRowCount(0);
        try {
        String result = String.valueOf(jComboBox3.getSelectedItem());
        ResultSet r = dbms.search("SELECT * FROM sessions WHERE selec_rm = '"+result+"' ");
        while(r.next()){
        String a=r.getString("selec_lec");
        String a1=r.getString("sg");
        String a2=r.getString("ss");

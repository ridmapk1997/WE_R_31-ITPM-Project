...
public class a6 extends javax.swing.JFrame {
    ...
    public a6() {
        ...
        try {
            ...
            while(r.next()){
                ...
                String a=r.getString("ays");
                String b=r.getString("p");
                String c=r.getString("gn");
                String d=r.getString("sgn");
                String e=r.getString("gi");
                String f=r.getString("sgi");
                Vector v=new Vector();
                v.add(id);
                v.add(a);
                v.add(b);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "IT", "SE", "CSNE", "CS", "ISE", "DS", "IM" }));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbms.iud("UPDATE stu_grp SET ays = '" + jTextField2.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE stu_grp SET p = '" + String.valueOf(jComboBox1.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE stu_grp SET gn = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE stu_grp SET sgn = '" + jTextField5.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE stu_grp SET gi = '" + jTextField6.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE stu_grp SET sgi = '" + jTextField7.getText() + "' WHERE `id` = '"+ id +"'");

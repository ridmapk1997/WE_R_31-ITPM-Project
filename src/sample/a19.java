...
public class a19 extends javax.swing.JFrame {
    ...
    public a19() {
        initComponents();
        loadData("sessions", "id", jComboBox2);
        loadData("sessions", "id", jComboBox3);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Sessions & Not Allocations");
        ...
        jButton19.setText("SESSION DETAILS");
        ...
        jButton21.setText("ADD SESSION ROOMS");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "consecutive", "parallel", "non overlapping", " " }));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbms.iud("INSERT INTO abcd (`type`,`ses`,`sess`) VALUES ('"+a+"','"+a1+"','"+a2+"')");
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        jLabel5.setText(a);
        ResultSet r=dbms.search("SELECT * FROM sessions WHERE id = '"+a+"' ");
        if(r.next()){

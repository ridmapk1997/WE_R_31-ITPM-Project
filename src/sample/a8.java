...
public class a8 extends javax.swing.JFrame {
    ...
    public a8() {
        ...
        try {
            ...
            while(r.next()){
                ...
                String b=r.getString("code");
                String c=r.getString("related");
                Vector v=new Vector();
                v.add(id);
                v.add(a);
                v.add(b);
    ...
    private void initComponents() {
        ...
        jButton24.setText("MANAGE WORKING DAYS & HOURS");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbms.iud("UPDATE tags SET name = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE tags SET code = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE tags SET related = '" + String.valueOf(jComboBox1.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");

...
public class a11 extends javax.swing.JFrame {
    ...
    public a11() {
        initComponents();
        try {
        ResultSet r=dbms.search("SELECT * FROM lecturers ORDER BY id DESC");
        r.next();
        String a = r.getString("lec_name");
        System.out.println(a);  
        jTextField2.setText(a);
        ResultSet r1=dbms.search("SELECT * FROM stu_grp ORDER BY id DESC");
        r1.next();
        String a1 = r1.getString("sgi");
        System.out.println(a1);  
        jTextField3.setText(a1);
        ResultSet r2=dbms.search("SELECT * FROM subjects ORDER BY id DESC");
        r2.next();
        String a2 = r2.getString("sn");
        System.out.println(a2);  
        jTextField4.setText(a2);
        ResultSet r7=dbms.search("SELECT * FROM loc ORDER BY id DESC");
        r7.next();
        String a7 = r7.getString("rn");
        System.out.println(a7);  
        jTextField5.setText(a7);
        ResultSet r3=dbms.search("SELECT * FROM lecturers");
        while(r3.next()){
        String a3=r3.getString("id");
        Vector v=new Vector();
        v.add(a3);
        ...
        ResultSet r4=dbms.search("SELECT * FROM stu_grp");
        while(r4.next()){
        String a4=r4.getString("id");
        Vector v=new Vector();
        v.add(a4);
        ...
        ResultSet r5=dbms.search("SELECT * FROM subjects");
        while(r5.next()){
        String a5=r5.getString("id");
        Vector v=new Vector();
        v.add(a5);
        ...
        ResultSet r6=dbms.search("SELECT * FROM loc");
        while(r6.next()){
        String a6=r6.getString("id");
        Vector v=new Vector();
        v.add(a6);
    ...
    private void initComponents() {
        ...
        jButton13.setText("SESSIONS & NOT ALLOCATIONS");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton18, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jLabel6.setFont(new java.awt.Font("Arial", 1, 60)); // NOI18N
        ...
        jLabel12.setText("Student Groups");
        ...
        jLabel15.setText("Latest Lecturer");
        ...
        jLabel18.setText("Latest Room Number");

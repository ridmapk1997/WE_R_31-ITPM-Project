...
public class a2 extends javax.swing.JFrame {
    ...
    public a2() {
        initComponents();
        try {
            ResultSet r=dbms.search("SELECT * FROM lecturers");
            while(r.next()){
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (r < 0) {
            ...
            try {
                dbms.iud("DELETE FROM lecturers WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        dbms.iud("UPDATE lecturers SET lec_name = '" + jTextField2.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET emp_id = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET fac = '" + String.valueOf(jComboBox1.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET dep = '" + String.valueOf(jComboBox2.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET center = '" + String.valueOf(jComboBox3.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET building = '" + String.valueOf(jComboBox4.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET level = '" + String.valueOf(jComboBox5.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
        dbms.iud("UPDATE lecturers SET rank = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");

...
public class a22 extends javax.swing.JFrame {
    ...
    public a22() {
        ...
        loadData("lecturers", "lec_name", jComboBox2);
        loadData("stu_grp", "gi", jComboBox3);
        loadData("stu_grp", "sgi", jComboBox4);
        loadData("sessions", "id", jComboBox5);
        
        try {
            ResultSet r=dbms.search("SELECT * FROM notavail");
            while(r.next()){
            String a=r.getString("id");
            String a1=r.getString("t");
            String a2=r.getString("sl");
            String a3=r.getString("sg");
            String a4=r.getString("ssg");
            String a5=r.getString("ssid");
                Vector v=new Vector();
                v.add(a);
                v.add(a1);
                v.add(a2);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Time", "Lecturerer", "Group", "Sub Group", "Session"
            }
        ) {
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try {
            ...
            dbms.iud("UPDATE notavail SET t = '" + jTextField5.getText() + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE notavail SET sl = '" + String.valueOf(jComboBox2.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE notavail SET sg = '" + String.valueOf(jComboBox3.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE notavail SET ssg = '" + String.valueOf(jComboBox4.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE notavail SET ssid = '" + String.valueOf(jComboBox5.getSelectedItem()) + "' WHERE `id` = '"+ id +"'");
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (r < 0) {
            ...
            try {
                dbms.iud("DELETE FROM notavail WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        try {
            ...
            if (r < 0) {
                ...
                Object o3 = jTable1.getValueAt(r, 2);
                String a3 = String.valueOf(o3);
                jComboBox2.setSelectedItem(o3);
                Object o4 = jTable1.getValueAt(r, 3);
                String a4 = String.valueOf(o4);
                jComboBox3.setSelectedItem(o4);
                Object o5 = jTable1.getValueAt(r, 4);
                String a5 = String.valueOf(o5);
                jComboBox4.setSelectedItem(o5);
                Object o6 = jTable1.getValueAt(r, 5);
                String a6 = String.valueOf(o6);
                jComboBox5.setSelectedItem(o6);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }

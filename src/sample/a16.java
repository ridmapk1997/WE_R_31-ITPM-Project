...
public class a16 extends javax.swing.JFrame {
    ...
    public a16() {
        initComponents();
        try {
            ResultSet r=dbms.search("SELECT * FROM wdh");
            while(r.next()){
                String id=r.getString("id");
                String a=r.getString("wd");
                String b=r.getString("d");
                String c=r.getString("h");
                String d=r.getString("m");
                Vector v=new Vector();
                v.add(id);
                v.add(a);
                v.add(b);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MANAGE WORKING DAYS & HOURS");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Number of Working Days", "Days", "Hours", "Minutes"
            }
        ) {
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        ...
        try {
            ...
            if (r < 0) {
                ...
                Object o2 = jTable1.getValueAt(r, 3);
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        if (r < 0) {
            ...
            String a = String.valueOf(o);
            try {
                dbms.iud("DELETE FROM wdh WHERE `id`='" + a + "'");
                TableModel tm = jTable1.getModel();
                DefaultTableModel dtm = (DefaultTableModel) tm;
                dtm.removeRow(r);
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        try {
            ...
            dbms.iud("UPDATE wdh SET wd = '" + jTextField2.getText() + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE wdh SET h = '" + jTextField3.getText() + "' WHERE `id` = '"+ id +"'");
            dbms.iud("UPDATE wdh SET m = '" + jTextField4.getText() + "' WHERE `id` = '"+ id +"'");

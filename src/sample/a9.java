...
public class a9 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton3.setBackground(java.awt.Color.orange);
        ...
        jTextField4.setForeground(java.awt.Color.orange);
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        jTextField4.setText("lecture hall");
        }else{
        jTextField2.setText("laboratory");
        }
        String a2=jTextField4.getText();
        String a3=jTextField2.getText();
        String a4=jTextField10.getText();
        dbms.iud("INSERT INTO loc (`bn`,`rn`,`rm1`,`rm2`,`c`) VALUES ('"+a+"','"+a1+"','"+a2+"','"+a3+"','"+a4+"')");
